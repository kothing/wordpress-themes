  ...
  $( function(){
    ...
    $.extend( AngiSlider.prototype, {
      ...
      _init_checkboxes : function(){
        var _checkwraper_selector = '.angi-toggle-check',
      ...
      //init angiSelect2 multipicker
      _init_multipicker : function(){
        if ( typeof $.fn.angiSelect2 !== 'function' ) return;
        this.$_slider_section_box.find('select.angi_multiple_picker, select.tc_multiple_picker').angiSelect2({
          closeOnSelect: false,
