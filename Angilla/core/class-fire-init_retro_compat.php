...
if ( is_user_logged_in() && current_user_can( 'edit_theme_options' ) ) {
    ...
    if ( ! empty( $theme_options ) ) {
        ...
        $_new_options_w_socials              = angi_fn_maybe_move_old_socials_to_customizer_fmk( $theme_options );
        ...
        //Custom css
        $_new_options_w_custom_css           = angi_fn_maybe_move_old_css_to_wp_embed( $theme_options );
        ...
        $_new_options_w_modern_skin          = angi_fn_maybe_move_classic_skin_to_modern( $theme_options );
        ...
        $_new_options_w_modern_sticky        = angi_fn_maybe_move_classic_sticky_header_to_modern( $theme_options );
        ...
        $_new_options_w_modern_header_wccart = angi_fn_maybe_move_classic_header_wccart_to_modern( $theme_options );
        ...
        $_new_options_w_modern_header_tagline = angi_fn_maybe_move_classic_header_tagline_to_modern( $theme_options );
        ...
        $_new_options_w_modern_header_search_location = angi_fn_maybe_move_old_header_mobile_search_to_new( $theme_options );
        ...
        $_new_options_w_modern_header_topbar_visibility = angi_fn_maybe_move_old_header_topbar_to_new( $theme_options );
        ...
        //modern style header topbar port
        $_new_options_w_modern_header_socials_visibility = angi_fn_maybe_move_old_header_socials_to_new( $theme_options );
...
function angi_fn_maybe_move_old_socials_to_customizer_fmk( $theme_options ) {
  ...
  */
  ...
  $_old_filtered_socials = apply_filters( 'tc_default_socials', ANGI___::$instance -> old_socials );
...
* returns array() the new set of options or empty if there's nothing to move
*/
function angi_fn_maybe_move_classic_skin_to_modern( $theme_options ) {
...
/*
* In the classic Angilla style we have only one option that controls the sticky header behavior 'tc_sticky_header' (boolean)
* In the modern Angilla style this option is splitted in two 'tc_header_desktop_sticky', 'tc_header_mobile_sticky'
...
* returns array() the new set of options or empty if there's nothing to move
*/
function angi_fn_maybe_move_classic_sticky_header_to_modern( $theme_options ) {
    /*
    * When Memcached is active transients (object cached) might be not persistent
    * we cannot really rely on them :/
    */
...
/*
* In the classic Angilla style we have only one option that controls the wc cart displaying in the header 'tc_woocommerce_header_cart' (bool)
* In the modern Angilla style this option is splitted in two 'tc_header_desktop_wc_cart' (string), 'tc_header_mobile_wc_cart' (bool)
...
* returns array() the new set of options or empty if there's nothing to move
*/
function angi_fn_maybe_move_classic_header_wccart_to_modern( $theme_options ) {
    /*
    * When Memcached is active transients (object cached) might be not persistent
    * we cannot really rely on them :/
    */
...
/*
* In the classic Angilla style we have only one option that controls the tagline displaying in the header 'tc_show_tagline' (bool)
* In the modern Angilla style this option is splitted in two 'tc_header_desktop_tagline' (string), 'tc_header_mobile_tagline' (bool)
* 'tc_header_desktop_wc_cart' is an array of the type:
* array(
*  'none',
*  'topbar',
...
* returns array() the new set of options or empty if there's nothing to move
*/
function angi_fn_maybe_move_classic_header_tagline_to_modern( $theme_options ) {
    /*
    * When Memcached is active transients (object cached) might be not persistent
    * we cannot really rely on them :/
    */
...
* returns array() the new set of options or empty if there's nothing to move
*/
function angi_fn_maybe_move_old_header_mobile_search_to_new( $theme_options ) {
    //nothing to do if already moved
...
* returns array() the new set of options or empty if there's nothing to move
*/
function angi_fn_maybe_move_old_header_topbar_to_new( $theme_options ) {
    //nothing to do if already moved
...
* returns array() the new set of options or empty if there's nothing to move
*/
function angi_fn_maybe_move_old_header_socials_to_new( $theme_options ) {
    //nothing to do if already moved
