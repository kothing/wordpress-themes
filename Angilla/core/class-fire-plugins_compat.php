...
if ( ! class_exists( 'ANGI_plugins_compat' ) ) :
  class ANGI_plugins_compat {
    ...
    function __construct () {
      ...
      /* ------------------------------------------------------------------------- */
      add_action( "ctx_set_filters_for_opt_group___tc_theme_options"  , array( $this , 'angi_fn_add_support_for_contextualizer') );
    }//end of constructor
    ...
    * => allows to easily remove support by firing remove_theme_support() (with a priority < angi_fn_plugins_compatibility) on hook 'after_setup_theme'
    ...
    */
    private function angi_fn_set_bbpress_compat() {
      if ( ! function_exists( 'angi_fn_bbpress_is_bbpress' ) ) {
        function angi_fn_bbpress_is_bbpress() {
      ...
      if ( ! function_exists( 'angi_fn_bbpress_disable_feature' ) ) {
        function angi_fn_bbpress_disable_feature( $bool ) {
          return angi_fn_bbpress_is_bbpress() ? false : $bool;
        }
      }
      if ( ! function_exists( 'angi_fn_bbpress_enable_feature' ) ) {
        function angi_fn_bbpress_enable_feature( $bool ) {
          return angi_fn_bbpress_is_bbpress() ? true : $bool;
        }
      }

      //inform angi we're not in a list of posts
      add_filter( 'angi_is_list_of_posts', 'angi_fn_bbpress_disable_feature' );

      //force display singular_title
      add_filter( 'angi_display_page_heading', 'angi_fn_bbpress_enable_feature' );

      //disables post metas
      add_filter( 'angi_show_post_metas', 'angi_fn_bbpress_disable_feature', 100);

      //disables post navigation
      add_filter( 'angi_show_post_navigation', 'angi_fn_bbpress_disable_feature' );

      //disable the smartload help block
      add_filter( 'tc_is_img_smartload_help_on', 'angi_fn_bbpress_disable_feature' );

      //disable author info in posts
      add_filter( 'angi_show_author_metas_in_post', 'angi_fn_bbpress_disable_feature' );

      //disable related posts
      add_filter( 'angi_display_related_posts', 'angi_fn_bbpress_disable_feature' );

      //custom css -> TODO: IMPROVE!
      add_filter( 'angi_user_options_style', 'angi_fn_bbpress_custom_style' );
      function angi_fn_bbpress_custom_style( $_css ) {

        if ( angi_fn_bbpress_is_bbpress() ) {
          return $_css . '
#subscription-toggle {
    float: right;
}
...
';
    ...
    /*
    * Same in angi classic except for comments enabled filter prefix (tc_ -> angi_)
    */
    /**
    ...
    */
    private function angi_fn_set_buddypress_compat() {
      ...
      //fired before wp_head where we hook angi_fn_parse_imgs
    ...
    /*
    * same in angi classic with filter prefixes change ( tc_ -> angi_ )
    */
    /**
    ...
    */
    private function angi_fn_set_qtranslatex_compat() {
      ...
      foreach ( array( 'angi_slide_link_url', 'tc_logo_link_url') as $filter )
        add_filter( $filter, 'angi_fn_url_lang' );

      //outputs the qtranslate translation for slider
      foreach ( array( 'angi_slide_title', 'angi_slide_text', 'angi_slide_button_text', 'angi_slide_background_alt', 'angi_posts_slider_button_text_pre_trim' ) as $filter )
      ...
      foreach ( array( 'angi_slide_title_length', 'angi_slide_text_length', 'angi_slide_button_length' ) as $filter )
      ...
      if ( ! apply_filters( 'tc_other_plugins_force_fpu_disable', class_exists('TC_fpu') ) && ! class_exists('TC_fpc') ) {
        ...
        add_filter( 'angi_fp_link_url' , 'angi_fn_url_lang');
        //outputs the qtranslate translation for featured pages
        add_filter( 'angi_fp_text', 'angi_fn_apply_qtranslate' );
        add_filter( 'angi_fp_button_text', 'angi_fn_apply_qtranslate' );
    ...
    */
    private function angi_fn_set_polylang_compat() {
      ...
      function angi_fn_pll_strings_setup() {
        // grab theme options
        $tc_options = angi_fn_get_theme_options();
      ...
      if ( function_exists( 'pll_get_post' ) && function_exists( 'pll__' ) && ! is_admin() ) {
        ...
        */
        ...
        add_filter( 'angi_fp_id', 'angi_fn_pll_page_id', 20 );
    ...
    */
    private function angi_fn_set_wpml_compat() {
      ...
      if ( ! is_admin() ) {
        ...
        /*A) FP*/
        // Featured pages ids "translation"
        add_filter( 'angi_fp_id', 'angi_fn_wpml_page_id', 20 );
    ...
    */
    private function angi_fn_set_the_events_calendar_compat() {
      ...
      */
      ...
      //disable related posts
      add_filter( 'angi_display_related_posts', 'angi_fn_tec_disable_related_posts' );
      function angi_fn_tec_disable_related_posts( $bool ) {
      ...
      add_filter( 'angi_is_list_of_posts', 'angi_fn_tec_disable_post_list');
      ...
      function angi_fn_tec_allow_display_breadcrumb_in_month_view() {
        ...
        add_filter( 'angi_breadcrumb_trail_args', 'angi_fn_tec_unhook_empty_post_type_archive_title');
        ...
        add_filter( 'angi_breadcrumb_trail_display', 'angi_fn_tec_rehook_empty_post_type_archive_title', PHP_INT_MAX );
    ...
    */
    private function angi_fn_set_event_tickets_compat() {
      ...
      add_filter( 'angi_is_list_of_posts', 'angi_fn_et_ticket_disable_post_list' );
      function angi_fn_et_ticket_disable_post_list( $bool ) {
    ...
    */
    private function angi_fn_set_sensei_compat() {
      ...
      add_filter( 'tc_opt_tc_related_posts', 'angi_fn_sensei_disable_related_posts' );
      function angi_fn_sensei_disable_related_posts( $bool ) {
          return ( function_exists('is_sensei') && is_sensei() ) ? 'disabled' : $bool;
      }

      //removes author info on __after_loop/__after_content hook
      add_filter( 'tc_opt_tc_show_author_info', 'angi_fn_sensei_disable_author_info' );
      function angi_fn_sensei_disable_author_info( $bool ) {
    ...
    */
    private function angi_fn_set_woocomerce_compat() {
      ...
      if ( apply_filters( 'angi_disable_woocommerce_breadcrumb', true ) )
      ...
      add_filter( 'angi_enable_lightbox_in_wc_short_description', '__return_true' );


      //enable images smartload in the wc short description
      add_filter( 'angi_enable_img_smart_load_in_wc_short_description', '__return_true' );
      ...
      add_filter( 'angi_show_slider', 'angi_fn_woocommerce_shop_enable');


      //allow page layout post meta in 'shop'
      add_filter( 'angi_is_page_layout', 'angi_fn_woocommerce_shop_enable' );


      //removes post comment action on __after_loop/__after_content hook
      add_filter( 'angi_are_comments_enabled', 'angi_fn_is_woocommerce_disable' );

      //removes related posts on __after_loop/__after_content hook
      add_filter( 'tc_opt_tc_related_posts', 'angi_fn_woocommerce_disable_related_posts' );
      function angi_fn_woocommerce_disable_related_posts( $bool ) {
          return ( function_exists('is_woocommerce') && is_woocommerce() ) ? 'disabled' : $bool;
      }

      //removes author info on __after_loop/__after_content hook
      add_filter( 'tc_opt_tc_show_author_info', 'angi_fn_is_woocommerce_disable' );
      ...
      add_filter( 'angi_anchor_smoothscroll_excl', 'angi_fn_woocommerce_disable_link_scroll' );
      ...
      add_filter( 'angi_post_meta_boxes_priority', 'angi_fn_woocommerce_change_meta_boxes_priority' , 2 , 10 );
      ...
      add_filter( 'angi_woocommerce_options_enabled_controller', 'angi_fn_woocommerce_options_enabled_controller' );
      function angi_fn_woocommerce_options_enabled_controller() {
        return function_exists( 'WC' );
      }

      // Maybe display
      add_filter( 'tc_opt_tc_single_post_thumb_location', 'angi_fn_woocommerce_single_product_thumb_location' );
      function angi_fn_woocommerce_single_product_thumb_location( $where ) {
        if ( function_exists( 'is_product' ) && is_product() ) {
            return angi_fn_is_checked('tc_woocommerce_display_product_thumb_before_mw' ) ?  '__before_main_wrapper' : 'hide';
        }
        return $where;
      }
      ...
      foreach ( array(
         ...
         add_filter( "angi_dynamic_{$filter_key}_prop_selectors", str_replace('-', '_', "angi_fn_wc_{$filter_key}_prop_selectors") );
      }

      function angi_fn_wc_skin_color_color_prop_selectors( $selectors ) {
      ...
      function angi_fn_wc_skin_color_background_color_prop_selectors( $selectors ) {
         return array_merge( $selectors, array(
      ...
      function angi_fn_wc_skin_color_border_color_prop_selectors( $selectors ) {
         return array_merge( $selectors, array(
      ...
      function angi_fn_wc_skin_dark_color_color_prop_selectors( $selectors ) {
         return array_merge( $selectors, array(
      ...
      function angi_fn_wc_skin_dark_color_background_color_prop_selectors( $selectors ) {
         return array_merge( $selectors, array(
            ...
            '.angi-link-hover-underline .widget_product_categories a:not(.btn)::before'
         ));
      }

      function angi_fn_wc_skin_dark_color_border_color_prop_selectors( $selectors ) {
         return array_merge( $selectors, array(
            '.woocommerce input#submit[class*=alt]:hover',
            '.woocommerce input.button[class*=alt]:hover',
            '.woocommerce a.button[class*=alt]:hover',
    ...
    /*
    * same in angi classic except for the filter prefix (tc_ -> angi_)
    */
    /**
    ...
    */
    private function angi_fn_set_vc_compat() {
      ...
      add_filter( 'angi_anchor_smoothscroll_excl', 'angi_fn_vc_disable_link_scroll' );
    ...
    */
    private function angi_fn_set_disqus_compat() {
      ...
      add_filter( 'angi_comment_info_anchor', 'angi_fn_disqus_comment_info_anchor' );
      function angi_fn_disqus_comment_info_anchor( $anchor ) {
        return angi_fn_disqus_comments_enabled() ? '#disqus_thread' : $anchor;
      }

      /*
      * Add disqus specific attribute to the comment link
      */
      add_filter( 'angi_comment_info_link_attributes', 'angi_fn_disqus_comment_info_link_attributes' );
      function angi_fn_disqus_comment_info_link_attributes( $attributes ) {
        if ( angi_fn_disqus_comments_enabled() && is_array( $attributes ) )
    ...
    */
    private function angi_fn_set_lp_compat() {
      ...
      add_filter( 'angi_is_list_of_posts', 'tc_lp_is_learnpress_disable');
      add_filter( 'angi_is_single_post', 'tc_lp_is_learnpress_disable');

      //enable page view for lp archives
      add_filter( 'angi_is_single_page', 'tc_lp_is_learnpress_enable');
    ...
    */
    ...
    function angi_fn_mainwrapper_start() {
      ...
      <div id="main-wrapper" class="section">
          ...
          ?>
        <?php  if ( apply_filters( 'big_heading_enabled', false && ! angi_fn_is_real_home() && ! is_404() ) ): ?>
          <div class="container-fluid">
            <?php
              if ( angi_fn_is_registered_or_possible( 'archive_heading' ) )
                $_heading_template = 'content/post-lists/headings/archive_heading';
              elseif ( angi_fn_is_registered_or_possible( 'search_heading' ) )
                $_heading_template = 'content/post-lists/headings/search_heading';
              elseif ( angi_fn_is_registered_or_possible('post_heading') )
              ...
              angi_fn_render_template( $_heading_template );
            ?>
          </div>
        <?php endif ?>
        ...
        <div class="<?php angi_fn_main_container_class() ?>" role="main">

          <?php do_action('__before_content_wrapper'); ?>

          <div class="<?php angi_fn_column_content_wrapper_class() ?>">

            <?php do_action('__before_content'); ?>

            <div id="content" class="<?php angi_fn_article_container_class() ?>">
      ...
      ?>
            ...
            <?php
                ...
                */
                ...
                if ( ! ( angi_fn_is_home_empty() || is_404() ) ) {
                  if ( angi_fn_is_registered_or_possible('left_sidebar') )
                    get_sidebar( 'left' );

                  if ( angi_fn_is_registered_or_possible('right_sidebar') )
                    get_sidebar( 'right' );
    ...
    // @param $opt_names = array() of Angilla options short name
    function angi_fn_add_support_for_contextualizer( $opt_names = array() ) {
