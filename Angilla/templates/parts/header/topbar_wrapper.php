...
*/
?>
<div class="topbar-navbar__wrapper <?php angi_fn_echo('element_class') ?>" <?php angi_fn_echo('element_attributes') ?>>
  <div class="<?php angi_fn_echo('element_inner_class') ?>">
    ...
    <div class="row flex-row flex-lg-nowrap justify-content-start justify-content-lg-end align-items-center topbar-navbar__row">
      ...
      <?php if ( angi_fn_is_registered_or_possible( 'topbar_menu' ) ) :?>
      ...
      <?php endif ?>
      <?php if ( angi_fn_is_registered_or_possible( 'topbar_tagline' ) )
      ...
      ?>
      <?php if ( angi_fn_is_registered_or_possible( 'topbar_social_block' ) ) : ?>
        <div class="topbar-nav__socials social-links col col-auto <?php angi_fn_echo( 'social_block_class' ) ?>">
          <?php
      ...
      <?php endif;
        ...
        angi_fn_render_template( 'header/parts/topbar_nav_utils', array(
          'model_args' => array(
