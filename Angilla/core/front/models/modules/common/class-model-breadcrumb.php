...
class ANGI_breadcrumb_model_class extends ANGI_Model {
  public  $breadcrumb;
  ...
  function angi_fn_extend_params( $model = array() ) {
    ...
    */
    $breadcrumb        = apply_filters( 'angi_breadcrumbs', '', $this->_args );
    $this->breadcrumb  = $breadcrumb ? $breadcrumb : $this->angi_fn_breadcrumb_trail( $this -> _args );
  ...
  function _get_args() {
    ...
    if ( is_singular() ) {
      ...
      $defaults["singular_breadcrumb_taxonomy"] = apply_filters( 'angi_display_taxonomies_in_breadcrumb' , true , $post->post_type );
    }

    /* Parse the arguments and extract them for easy variable naming. */
    return  apply_filters( 'angi_breadcrumb_trail_args' , wp_parse_args( $args, $defaults) , $args , $defaults );
  }//end of function
  ...
  function angi_fn_breadcrumb_trail( $args = array() ) {
    ...
    /* Get the trail items. */
    $trail = apply_filters( 'angi_breadcrumb_trail' , $this -> angi_fn_breadcrumb_trail_get_items( $args ) );
  ...
  function angi_fn_breadcrumb_trail_get_items( $args = array() ) {
    ...
    return apply_filters( 'angi_breadcrumb_trail_items' , $trail, $args );
  }
