<?php
class ANGI_media_model_class extends ANGI_Model {
      ...
      */
      public function __construct( $model = array() ) {
            ...
            */
            $this->defaults = array(
                  ...
                  'image_centering'       => esc_attr( angi_fn_opt( 'tc_center_img' ) ) ? 'js-centering' : 'css-centering',
                  'inner_wrapper_class'   => null,
            );
      ...
      public function angi_fn_setup_late_properties() {
            ...
            /*
            * This is if the model is called without setting up the media (angi_fn_setup)
            */
            ...
            $this->angi_fn__setup_media_wrapper();
      }


      /*
      * $type can be:
      * a) all (video,audio,angi_thumb,wp_thumb)
      * b) angi_thumb
      * c) wp_thumb
      */
      public function angi_fn__setup_media() {


            if ( $this->use_icon && $this->force_icon ) {

                  $this->angi_fn__setup_media_to_render( 'format-icon' );
                  return;
            ...
            if ( 'gallery' == $media_type && ! apply_filters( 'angi_allow_gallery_carousel_in_post_lists', false ) ) {
            ...
            switch ( $media_type ) {
                  ...
                  case 'video' :
                        ...
                        $_instance = $this -> angi_fn__get_instance_from_model_array( array(
                        ...
                        $this->angi_fn__setup_media_to_render( $media = $_instance->angi_fn_get_raw_media(), $media_template = 'content/common/media/video', $model_id = $_instance->angi_fn_get_property( 'id' ) );
                  ...
                  case 'audio' :
                        ...
                        $this->angi_fn__setup_media_to_render( $media = $_instance->angi_fn_get_raw_media(), $media_template = 'content/common/media/audio', $model_id = $_instance->angi_fn_get_property( 'id' ) );
                  ...
                  case 'gallery' :
                        ...
                        $this->angi_fn__setup_media_to_render( $media = $_instance->angi_fn_get_raw_media(), $media_template = 'content/common/media/gallery', $model_id = $_instance->angi_fn_get_property( 'id' ) );
                  ...
                  default:
                        ...
                        if ( $_instance ) {
                              ...
                              $has_thumbnail    = $this->angi_fn__setup_media_to_render( $_instance->angi_fn_get_raw_media(), $media_template = 'content/common/media/thumbnail', $model_id = $_instance->angi_fn_get_property( 'id' ) );
                        }
            ...
            if ( is_null( $this->media ) )
                  $this->angi_fn_set_property( 'media',  false );
      }




      protected function angi_fn__setup_media_to_render( $media, $media_template = null , $model_id = null ) {

            if ( $media ) {

                  $this->angi_fn_set_property( 'media',  $media );


                  $this->angi_fn_set_property( 'media_template',  $media_template );


                  $this->angi_fn_set_property( 'media_args',  array( 'model_id' => $model_id, 'reset_to_defaults' => false ) );
      ...
      //'image_centering'       => esc_attr( angi_fn_opt( 'tc_center_img' ) ) ? 'js-centering' : 'css-centering',
      protected function angi_fn__setup_media_wrapper() {
            ...
            if ( in_array( $this -> media_template, array( 'content/common/media/thumbnail', 'content/common/media/gallery' ) ) ) {
                  ...
                  $this->angi_fn_set_property( 'inner_wrapper_class', $inner_wrapper_class );

            } else {

                  /* Set availability of background link */
                  $this->angi_fn_set_property( 'has_permalink', false );
      ...
      /* Helper */
      protected function angi_fn__get_instance_from_model_array( $model = array() ) {

            $_id = angi_fn_maybe_register( $model );

            return angi_fn_get_model_instance( $_id );
