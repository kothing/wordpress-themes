                ...
                <div class="panel panel-tougao">
                    ...
                    <form id="tougao" class="io-tougao mb-4" method="post" action="<?php echo $_SERVER["REQUEST_URI"]?>">
                        <div style="text-align: left; padding-top: 10px;">
                            <label for="tougao_site_ico"><?php _e('网站图标:','i_theme') ?></label>
                            <input type="hidden" value="" id="tougao_site_ico" name="tougao_site_ico" />
                            <div class="upload_img">
                                <div class="show_ico">
                                    <img id="show_site_ico" src="<?php echo get_theme_file_uri('/images/add.png') ?>" alt="<?php _e('网站图标','i_theme') ?>">
                                    <i id="remove_site_ico" class="fa fa-times-circle remove" data-id="" data-type="site_ico" style="display: none;"></i>
                                </div> 
                                <input type="file" id="upload_site_ico" data-type="site_ico" accept="image/*" onchange="uploadImg(this)" >
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-sm-6 mt-2">
                                ...
                                <input type="text" class="form-control" value="" id="tougao_site_link" name="tougao_site_link" placeholder="<?php _e('网站链接','i_theme') ?>"/>
                                </div>
                            </div>
                            <div class="col-sm-6 mt-2">
                                <div class="input-group">
                                    <div class="input-group-addon"><i class="fa fa-braille fa-fw" aria-hidden="true"></i></div>
                                <input type="text" class="form-control" value="" id="tougao_site_sescribe" name="tougao_site_sescribe"  placeholder="<?php _e('网站描述','i_theme') ?> *" maxlength="50"/>
                                </div>
                            </div>
                            <div class="col-sm-6 mt-2">
                                <div class="input-group">
