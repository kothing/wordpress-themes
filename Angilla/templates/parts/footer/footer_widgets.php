...
*/
?>
<div id="footer-widget-area" class="widget__wrapper" role="complementary" <?php angi_fn_echo('element_attributes') ?>>
  <div class="container widget__container">
    <div class="row">
      <?php do_action("__before_footer_widgets") ?>
      <?php
        $_footer_widgets  = apply_filters( 'angi_footer_widgets', ANGI_init::$instance -> footer_widgets );
