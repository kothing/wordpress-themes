...
( function( api, $, _ ) {
        ...
        if ( serverPreviewParams && ! serverPreviewParams.preview_ready_event_exists ) {
              try { api.angi_preview = new api.ANGI_preview(); } catch( _er_ ) {
                    console.log( "new api.ANGI_preview() => error => ", _er_ );
              }
        }
        else {
        ...
        var angiPreviewConstructor = {
              ...
              syncData : function() {
                  api.preview.send( 'angi-query-data-ready', api.settings.angi_wpQueryInfos );
                  api.preview.send(
                        'angi-partial-refresh-data',
              ...
              addCbs : function() {
                    ...
                    api.preview.bind( 'angi_input', function( args ) {
                          var _defaults = {
                                set_id : '',
                                module_id : '',
                                item_id : '',
                    ...
                    api.selectiveRefresh.bind( 'partial-content-rendered', function( params ) {
                            ...
                            api.preview.send( 'angi-partial-refresh-done', { set_id : self._build_setId( params.partial.id ) } );
                    });
              },
        ...
        };//angiPreviewConstructor

        api.ANGI_preview = api.Class.extend( angiPreviewConstructor );
