...
*/
?>
<div class="right sidebar tc-sidebar <?php angi_fn_echo('element_class')?>" <?php angi_fn_echo('element_attributes') ?>>
  <div id="right" class="widget-area" role="complementary">
    <?php do_action( '__before_inner_right_sidebar' ) ?>
    <?php if ( angi_fn_is_registered_or_possible('rights_social_block') ) : ?>
