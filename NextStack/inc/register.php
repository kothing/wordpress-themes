...
function theme_load_scripts() {
	...
	wp_register_style( 'style',             THEME_URL.'/style.css', array(), $theme_version );
	...
	wp_register_style( 'theme',             THEME_URL.'/css/theme.css', array(), $theme_version );
	...
	wp_register_script( 'next-popover',     THEME_URL.'/js/next-popover.umd.js', array(), $theme_version, true );
	...
	if( !is_admin() ) {
		...
		wp_enqueue_script('next-popover');
