...
( function( api ) {
	var colorScheme  = mipressColorMain.colorScheme;
	var colorOptions = mipressColorMain.colorOptions;
	var cssTemplate = wp.template( 'mipress-color-scheme' ),
