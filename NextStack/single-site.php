            ...
            <?php while( have_posts() ): the_post();?>
                <div class="row">
                    <div class="col-12 col-sm-4 col-lg-3">
                        <?php 
                        $m_link_url  = get_post_meta($post->ID, '_site_link', true); 
                    ...
                    <div class="col-12 col-sm-8 col-lg-5 mt-4 mt-md-0">
                        <div class="p-xl-4">
                            ...
                            <div class="mt-2">
                                <p><?php echo get_post_meta(get_the_ID(), '_site_sescribe', true) ?></p>
                                <?php 
                                ...
                                <?php endif; ?>
                                <a href="javascript:" class="btn btn-arrow" data-toggle="tooltip" data-placement="bottom" title="" data-html="true" data-original-title="<img src='<?php echo $qrurl ?>' width='150'>">
                                    <span><?php echo $qrname ?><i class="fa fa-qrcode"></i></span>
                                </a>
                                </div>
                            </div>
                    ...
                    <div class="col-12 col-sm-12 col-lg-4 mt-4 mt-lg-0">
                        <?php 
                            if(io_get_option('ad_right_s')) {
                                echo '<div class="ad ad__right">' . stripslashes( io_get_option('ad_right') ) . '</div>'; 
                            }
                        ?>
                    </div>
                </div>
                <div class="mt-4 pt-4 border-top">
                    <?php  
                        ...
                        if( $contentinfo ) {
                            ...
                            echo get_post_meta(get_the_ID(), '_site_sescribe', true);
                        }
                    ?>
                </div>
            <?php endwhile; ?>
            </div>
            <?php edit_post_link(__('编辑','i_theme'), '<div class="site-footer"><span class="edit-link">', '</span></div>' ); ?>
        </div>
        <div class="related-site">
            <h4 class="text-gray mt-4">
                <i class="icon-io-tag" style="margin-right: 27px;" id="relevant_c"></i>
                <?php _e('相关导航','i_theme') ?>
            </h4>
            <div class="row"> 
                <?php
                ...
                if ($i < $post_num) {
                    ...
                    if ($related_items->have_posts()) :
                        ...
                        $link_url = get_post_meta($post->ID, '_site_link', true); 
