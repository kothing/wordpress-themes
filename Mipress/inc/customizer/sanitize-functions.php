 ...
 */
function mipress_sanitize_select( $input, $setting ) {
 ...
 */
function mipress_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 */
function mipress_sanitize_post( $input ) {
 ...
 */
function mipress_sanitize_image( $image, $setting ) {
    /*
 ...
 * @since Mipress 0.1
 */
function mipress_sanitize_category_list( $input ) {
    if ( '' != $input ) {
        if( in_array( 0, $input ) ) {
            return '0';
        }
 ...
 *                    the setting default.
 */
function mipress_sanitize_number_range( $number, $setting ) {
