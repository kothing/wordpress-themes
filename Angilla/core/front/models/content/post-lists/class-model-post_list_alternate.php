<?php
class ANGI_post_list_alternate_model_class extends ANGI_Model {
            ...
            'standard'   => array(
                  ...
                  'tcthumb' => array(
                        ...
                        'media'                 => array(
                              ...
                              'wrapper_class'      => '',
                              'thumb_size'         => 'tc-thumb',
                              'inner_class'        => 'angi__r-wTCT',
                              'link_class'         => 'angi-link-mask',
                              'wrapper_icon_class' => 'align-self-center'
                        ),
                  )
            ),
      ...
      *
      * It differentiates from the ANGI_Model.defaults as the latter can be (by default is) parsed into
      ...
      */
      function angi_fn_get_preset_model() {
            ...
            $_preset = array(
                  'thumb_alternate'         => esc_attr( angi_fn_opt( 'tc_post_list_thumb_alternate' ) ),
                  'thumb_position'          => esc_attr( angi_fn_opt( 'tc_post_list_thumb_position' ) ),
                  ...
                  'thumb_shape_effect'      => strstr(  esc_attr( angi_fn_opt( 'tc_post_list_thumb_shape' ) ),'rounded' ) ? angi_fn_opt( 'tc_post_list_thumb_shape' ) : 'regular'
            );
      ...
      */
      function angi_fn_extend_params( $model = array() ) {
            ...
            $model[ 'post_list_layout' ]        = $this -> angi_fn__get_post_list_layout( $model );
      ...
      */
      function angi_fn_setup_late_properties() {
            ...
            array_push( $this->post_list_items, $this->angi_fn__get_post_list_item() );
      }
      ...
      */
      function angi_fn_reset_late_properties() {
            ...
            if ( angi_fn_is_loop_end() ) {
                  ...
                  $this -> angi_fn_reset_post_list_items();
      ...
      *  Public getters
      */
      function angi_fn_get_content_class() {
            return $this -> angi_fn__get_post_list_item_property( 'content_class' );
      }

      function angi_fn_get_media_class() {
            return $this -> angi_fn__get_post_list_item_property( 'media_class' );
      }

      function angi_fn_get_sections_wrapper_class() {
            return $this -> angi_fn__get_post_list_item_property( 'sections_wrapper_class' );
      }

      function angi_fn_get_grid_item_class() {
            return $this -> angi_fn__get_post_list_item_property( 'grid_item_class' );
      }

      function angi_fn_get_article_selectors() {
            return $this -> angi_fn__get_post_list_item_property( 'article_selectors' );
      }

      function angi_fn_get_media_link_class() {
            return $this -> angi_fn__get_post_list_item_property( 'media_link_class' );
      }

      function angi_fn_get_media_inner_class() {
            return $this -> angi_fn__get_post_list_item_property( 'media_inner_class' );
      }

      function angi_fn_get_has_post_media() {
            return $this -> angi_fn__get_post_list_item_property( 'has_post_media' );
      }
      ...
      *  @return array
      */
      protected function angi_fn__get_post_list_item() {
            ...
            $_layout                       = apply_filters( 'angi_post_list_layout', $this -> post_list_layout );

            $_current_post_format          = get_post_format();

            $post_content                  = $this->angi_fn__get_post_content(
                  $post_id          = null,
            ...
            $is_full_image                 = $this->angi_fn_is_full_image( $_current_post_format, (bool)$post_content );

            $maybe_has_format_icon_media   = $this->angi_fn_maybe_has_format_icon_media( $_current_post_format );

            $force_format_icon_media       = $this->angi_fn_force_format_icon_media( $_current_post_format );
            ...
            $post_media                    = $this->show_thumb ? $this->angi_fn__get_post_media ( array(
                  ...
                  */
                  ...
                  if ( 'full-image' !== $post_info_key ) {
                        ...
                        if ( ! $this->has_narrow_layout )
                            ...
                            $_sections_wrapper_class[] = !$cover_sections ? 'angi-center-sections' : 'angi-cover-sections';
                  }
            ...
            $media_class       = $media_cols  = $this -> angi_fn_build_cols( $media_layout );
            ...
            $article_selectors             = $this -> angi_fn__get_article_selectors(
                  $is_full_image,
                  $has_post_media,
      ...
      */
      protected function angi_fn__get_article_selectors( $is_full_image, $has_post_media, $has_format_icon_media, $thumb_shape, $thumb_effect ) {

            $post_class              = $this->post_class;
            $is_full_image           = $is_full_image && $has_post_media;
            $has_thumb               = $has_post_media && !$has_format_icon_media;

            $thumb_shape             = $thumb_shape && $has_thumb && !$is_full_image ? "$thumb_shape angi-link-mask-p" : false;
            ...
            return angi_fn_get_the_post_list_article_selectors( array_filter($post_class), $id_suffix );
      ...
      */
      protected function angi_fn__get_post_list_item_property( $_property ) {
      ...
      */
      protected function angi_fn_is_full_image( $_current_post_format, $_get_post_content ) {
            /*
            *
            ...
            */
            ...
            // and remove if ( apply_filters( 'angi_allow_gallery_carousel_in_post_lists', false ) ) block below
            ...
            if ( apply_filters( 'angi_allow_gallery_carousel_in_post_lists', false ) ) {
      ...
      */
      function angi_fn_maybe_has_format_icon_media( $current_post_format ) {
      ...
      function angi_fn_force_format_icon_media( $current_post_format ) {
      ...
      *
      */
      function angi_fn_build_cols( $_widths ) {
      ...
      */
      ...
      protected function angi_fn__get_post_media( $media_args = array() ) {
            $defaults = array(
                  'post_id'               => null,
                  'post_format'           => null,
                  'type'                  => 'all',
            ...
            $_id       = angi_fn_maybe_register( array(
            ...
            $_instance = angi_fn_get_model_instance( $_id );

            if ( !$_instance )
                  return false;

            //setup the media
            $_instance -> angi_fn_setup( $media_args );


            return $_instance -> angi_fn_get_raw_media();
      ...
      protected function angi_fn__get_post_content( $post_id = null, $post_format = null, $type = 'excerpt' ) {
            ...
            return $_instance -> angi_fn_get_raw_content();
