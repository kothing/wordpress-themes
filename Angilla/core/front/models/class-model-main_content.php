...
class ANGI_main_content_model_class extends ANGI_Model {
      /*
      * @override
      */
      function __construct( $model ) {
            ...
            $this -> angi_fn_process_singular_thumbnail();

            //in singular context handle where to display blocks like:
            // - author info (single),
            // - related posts (single),
            // - comments (page)
            $this -> angi_fn_process_singular_blocks();
            ...
            $children = array(
                  ...
                  *********************************************/
                  ...
                  /* Needs to access the angi_user_options_style */
                  /*********************************************
                  * GRID (POST LIST)
                  *********************************************/
                  array(
      ...
      function angi_fn_process_singular_thumbnail() {
            ...
            if ( ! angi_fn_is_registered_or_possible( "regular_{$context}_heading" ) ) {
                  return;
            }
            ...
            $_singular_thumb_option = angi_fn_opt( "tc_single_${context}_thumb_location" );
            ...
            //define old angilla compatibility map:
            ...
            $singular_thumb_model_id = angi_fn_register( array( 'template' => 'content/common/media',
            ...
            add_filter( "angi_do_render_view_{$singular_thumb_model_id}", array( $this, 'angi_fn_display_view_singular_thumbnail' ), 100, 2 );

            //css
            //needed only when not __after_regular_heading_title?
            //if ( '__after_regular_heading_title' != $_hook ) {

            add_filter( 'angi_user_options_style'    , array( $this , 'angi_fn_write_thumbnail_inline_css') );
      ...
      */
      function angi_fn_display_view_singular_thumbnail( $bool, $model ) {
      ...
      function angi_fn_write_thumbnail_inline_css( $_css ) {
            ...
            $_thumb_smartphone_height   = apply_filters( "tc_single_{$context}_thumb_smartphone_height", esc_attr( angi_fn_opt( "tc_single_{$context}_thumb_smartphone_height" ) ) );

            $_thumb_smartphone_height   = (! $_thumb_smartphone_height || ! is_numeric($_thumb_smartphone_height) ) ? 200 : $_thumb_smartphone_height;

            $_thumb_height              = apply_filters( "tc_single_{$context}_thumb_height", esc_attr( angi_fn_opt( "tc_single_{$context}_thumb_height" ) ) );
      ...
      * @return void
      */
      private function angi_fn_process_singular_blocks() {
            ...
            foreach ( $_option_name_model_configuration as $_option_name => $model_configuration ) {
                  ...
                  $_location_info = esc_attr( angi_fn_opt( $_option_name ) );
                  ...
                  if ( $_location_info && array_key_exists( $_location_info, $_option_location_hook ) ) {
                        ...
                        angi_fn_register( $model_configuration );
                  }
            }
      }
}