...
if ( ! function_exists( 'mipress_featured_image' ) ) :
	/**
	 * Template for Featured Header Image from theme options
	 *
	 * To override this in a child theme
	 * simply create your own mipress_featured_image(), and that function will be used instead.
	 *
	 * @since Mipress 0.1
	 */
	function mipress_featured_image() {
	...
	} // mipress_featured_image
endif;

if ( ! function_exists( 'mipress_featured_page_post_image' ) ) :
	/**
	 * Template for Featured Header Image from Post and Page
	 *
	 * To override this in a child theme
	 * simply create your own mipress_featured_imaage_pagepost(), and that function will be used instead.
	 *
	 * @since Mipress 0.1
	 */
	function mipress_featured_page_post_image() {
		$thumbnail = is_front_page() ? 'mipress-header-inner' : 'mipress-slider';
	...
	} // mipress_featured_page_post_image
endif;

if ( ! function_exists( 'mipress_featured_overall_image' ) ) :
	/**
	 * Template for Featured Header Image from theme options
	 *
	 * To override this in a child theme
	 * simply create your own mipress_featured_pagepost_image(), and that function will be used instead.
	 *
	 * @since Mipress 0.1
	 */
	function mipress_featured_overall_image() {
		...
		return false;
	} // mipress_featured_overall_image
endif;
