<?php
class ANGI_post_list_item_header_model_class extends ANGI_Model {
  ...
  */
  function angi_fn_setup_late_properties() {
    ...
    $this -> angi_fn_set_property( 'element_class', $element_class );
    $this -> angi_fn_set_property( 'the_title', $the_title );
  }
