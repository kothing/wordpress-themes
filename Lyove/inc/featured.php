...
class Featured_Content {
	...
	public static function customize_register( $wp_customize ) {
		...
		$wp_customize->add_setting(
			'featured-content[tag-name]', array(
				'default'              => _x( 'featured', 'featured content default tag slug', 'lyove' ),
				'type'                 => 'option',
		...
		$wp_customize->add_control(
			'featured-content[hide-tag]', array(
				'label'    => __( 'Don&rsquo;t display tag on front end.', 'lyove' ),
				'section'  => 'featured_content',
				'type'     => 'checkbox',
				'priority' => 30,
			)
	...
	public static function enqueue_scripts() {
		wp_enqueue_script( 'featured-content-suggest', get_template_directory_uri() . '/assets/js/featured-content-admin.js', array( 'jquery', 'suggest' ), '1.0.0', true );
	}
	...
	public static function get_setting( $key = 'all' ) {
		...
		$defaults = array(
			'hide-tag' => 1,
			'tag-id'   => 0,
			'tag-name' => _x( 'featured', 'featured content default tag slug', 'lyove' ),
		);
