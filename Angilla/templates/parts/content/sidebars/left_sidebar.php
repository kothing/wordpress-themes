...
*/
?>
<div class="left sidebar tc-sidebar <?php angi_fn_echo('element_class')?>" <?php angi_fn_echo('element_attributes') ?>>
  <div id="left" class="widget-area" role="complementary">
    <?php do_action( '__before_inner_left_sidebar' ) ?>
    <?php if ( angi_fn_is_registered_or_possible('lefts_social_block') ) : ?>
