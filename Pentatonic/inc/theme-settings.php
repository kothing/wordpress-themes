...
CSF::createOptions( $prefix, array(
    'framework_title' => 'Pentatonic <small>V'.wp_get_theme()->get('Version').'</small> <span style="font-size:12px">请前往 <a href="'.home_url().'/wp-admin/index.php">仪表盘</a> 仔细阅读使用说明，谢谢！</span>',
    ...
    'footer_credit'   => '感谢您使用 <a href="https://nice-boy.com/" target="_blank">NiceBoy</a>的WordPress主题',
));
...
CSF::createSection( $prefix, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'after'   => __('一行一个地址，注意不要有空格。<br>需要包含http(s)://<br>nice-boy.com和www.nice-boy.com为不同的网址<br>此设置同时用于 nofollow 的排除。','io_setting'),
        ),
        array(
            'id'      => 'save_image',
            'type'    => 'switcher',
...
CSF::createSection( $prefix, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'desc'       => '输入图标库在线链接，图标库地址：<a href="https://www.iconfont.cn/" target="_blank">--></a><br>教程地址：<a href="https://www.nice-boy.com/" target="_blank">--></a>',
        ...
        array(
            'type'    => 'submessage',
            'style'   => 'danger',
            'content' => __('邮件发信服务设置，如果你不需要评论邮件通知等功能，可不设置。<p>国内一般使用 SMTP 服务，<a href="https://www.nice-boy.com/" target="_blank">设置方法</a></p>','io_setting'),
        ),
        ...
        array(
            ...
            'subtitle'   => __('可用二维码api源地址：','io_setting').'<a href="https://www.nice-boy.com/" target="_blank">--></a>',
...
CSF::createSection( $prefix, array(
    ...
    'fields'      => array(
        ...
        array(
            ...
            'default'    => '<a href="https://www.nice-boy.com/" target="_blank"><img src="' . get_theme_file_uri('/images/ad.jpg').'" alt="广告也精彩" /></a>',
            'settings'   => array(
                'theme'  => 'dracula',
                'mode'   => 'javascript',
            ),
...
CSF::createSection( $prefix, array(
    ...
    'fields'      => array(
        ...
        array(
            ...
            'default'    => '<a href="https://www.nice-boy.com/" target="_blank"><img src="' . get_theme_file_uri('/screenshot.jpg').'" alt="广告也精彩" /></a>',
            'settings'   => array(
                'theme'  => 'dracula',
                'mode'   => 'javascript',
            ),
