...
if ( ! function_exists( 'angi_fn_page_wrapper_class' ) ) {
      function angi_fn_page_wrapper_class() {
            echo angi_fn_stringify_array( angi_fn_get_page_wrapper_class() );
      }
}
...
*/
if ( ! function_exists( 'angi_fn_column_content_wrapper_class' ) ) {
      function angi_fn_column_content_wrapper_class() {
            echo angi_fn_stringify_array( angi_fn_get_column_content_wrapper_class() );
      }
}
...
*/
if ( ! function_exists( 'angi_fn_main_container_wrapper_class' ) ) {
      function angi_fn_main_container_class() {
            echo angi_fn_stringify_array( angi_fn_get_main_container_class() );
      }
}
...
*/
if ( ! function_exists( 'angi_fn_article_container_class' ) ) {
      function angi_fn_article_container_class() {
            echo angi_fn_stringify_array( angi_fn_get_article_container_class() );
      }
}
...
if ( ! function_exists( 'angi_fn_get_theme_file_path' ) ) {
      function angi_fn_get_theme_file_path( $path_suffix ) {
            return ANGI() -> angi_fn_get_theme_file_path( $path_suffix );
      }
}
/*
 * @since 3.5.0
 */
//shortcut function to get a theme file
if ( ! function_exists( 'angi_fn_get_theme_file_url' ) ) {
      function angi_fn_get_theme_file_url( $url_suffix ) {
            return ANGI() -> angi_fn_get_theme_file_url( $url_suffix );
      }
}
/*
 * @since 3.5.0
...
if ( ! function_exists( 'angi_fn_require_once' ) ) {
      function angi_fn_require_once( $path_suffix ) {
            return ANGI() -> angi_fn_require_once( $path_suffix );
      }
}
 ...
 * @since 3.5.0
 */
//shortcut function to set the current model which will be accessible by the angi_fn_get
if ( ! function_exists( 'angi_fn_set_current_model' ) ) {
      function angi_fn_set_current_model( $model ) {
            return ANGI() -> angi_fn_set_current_model( $model );
      }
}
...
if ( ! function_exists( 'angi_fn_reset_current_model' ) ) {
      function angi_fn_reset_current_model() {
            return ANGI() -> angi_fn_reset_current_model();
      }
}
...
if ( ! function_exists( 'angi_fn_get_property' ) ) {
      function angi_fn_get_property( $property, $model_id = null, $args = array() ) {
            return ANGI() -> angi_fn_get_property( $property, $model_id, $args );
      }
}
...
if ( ! function_exists( 'angi_fn_get_model' ) ) {
      function angi_fn_get_model() {
            return ANGI() -> angi_fn_get_current_model();
      }
}
...
if ( ! function_exists( 'angi_fn_echo' ) ) {
      function angi_fn_echo( $property, $model_id = null, $args = array() ) {
            return ANGI() -> angi_fn_echo( $property, $model_id, $args );
      }
}
...
if ( ! function_exists( 'angi_fn_new' ) ) {
      function angi_fn_new( $_to_load, $_args = array() ) {
            ANGI() -> angi__fn_( $_to_load , $_args );
            return;
      }
}
...
* @return void
*/
if ( ! function_exists( 'angi_fn_render_template' ) ) {
      function angi_fn_render_template( $template, $args = array() ) {
            ...
            * When rendering the gallery template, through the angi_fn_render_template function, thus, we just want to render what has been already
            * computed.
            ...
            */
            ...
            if ( angi_fn_is_registered( $_model_id ) ) {

                $model_instance = angi_fn_get_model_instance( $_model_id );

                //sets the template property on the fly based on what's requested
                if ( ! angi_fn_get_model_property( $_model_id, 'template') ) {
                    $model_instance -> angi_fn_set_property('template' , $_t );
                }

                //update model with the one passed
                if ( is_array($args) && array_key_exists( 'model_args', $args) ) {
                      $model_instance -> angi_fn_update( $_model_args, $_reset_to_defaults );
                } elseif ( $_reset_to_defaults ) {
                      $model_instance -> angi_fn_reset_to_defaults();
                }

                angi_fn_get_view_instance( $_model_id ) -> angi_fn_maybe_render();
            } else {
                ...
                //=> the render param is therefore set to true ( @see class model : angi_fn_maybe_hook_or_render_view  :
                //if ( did_action( 'template_redirect' ) && $this -> render ) {
                //     $instance -> angi_fn_maybe_render();
...
if ( ! function_exists( 'angi_fn_is_registered_or_possible' ) ) {
      function angi_fn_is_registered_or_possible( $_t, $_id = null, $only_registered = false ) {
            $_model_id = is_null($_id) ? $_t : $_id;

            if ( ANGI() -> collection -> angi_fn_is_registered( $_model_id ) ) {
                  return true;
            }
            ...
            elseif ( ! $only_registered ) {
                  return ANGI() -> controllers -> angi_fn_is_possible( $_model_id );
            }
...
if ( ! function_exists( 'angi_fn_is_registered' ) ) {
      function angi_fn_is_registered( $_model_id ) {
            return ANGI() -> collection -> angi_fn_is_registered( $_model_id );
      }
}

//@return boolean
//states if possible
if ( ! function_exists( 'angi_fn_is_possible' ) ) {
      function angi_fn_is_possible( $_model_id ) {
            return ANGI() -> controllers -> angi_fn_is_possible( $_model_id );
      }
}

//@return model object if exists
if ( ! function_exists( 'angi_fn_get_model_instance' ) ) {
      function angi_fn_get_model_instance( $_model_id ) {
            if ( ! ANGI() -> collection -> angi_fn_is_registered( $_model_id ) )
                  return;

            return ANGI() -> collection -> angi_fn_get_model_instance( $_model_id );
      }
}
...
if ( ! function_exists( 'angi_fn_get_model_property' ) ) {
      function angi_fn_get_model_property( $_model_id, $_property ) {
            if ( ! ANGI() -> collection -> angi_fn_is_registered( $_model_id ) )
                  return;

            $model_instance = ANGI() -> collection -> angi_fn_get_model_instance( $_model_id );
            return $model_instance -> angi_fn_get_property($_property);
      }
}

//@return view model object if exists
if ( ! function_exists( 'angi_fn_get_view_instance' ) ) {
      function angi_fn_get_view_instance( $_model_id ) {
            $model_instance = ANGI() -> collection -> angi_fn_get_model_instance( $_model_id );
...
if ( ! function_exists( 'angi_fn_register' ) ) {
      function angi_fn_register( $model = array() ) {
            return ANGI() -> collection -> angi_fn_register( $model );
      }
}
...
if ( ! function_exists( 'angi_fn_maybe_register' ) ) {
      function angi_fn_maybe_register( $model = array() ) {

            $_model_id = array_key_exists( 'id', $model ) && !empty( $model[ 'id' ] ) ? $model[ 'id' ] : false;

            if ( $_model_id && angi_fn_is_registered( $_model_id ) )
                  return $_model_id;
...
function angi_fn_wp_filters() {
    ...
    if ( apply_filters( 'angi_enable_lightbox_in_wc_short_description', false  ) ) {
        add_filter( 'woocommerce_short_description', 'angi_fn_fancybox_content_filter' );
    }
    /*
    * Smartload disabled for content retrieved via ajax
    */
    if ( apply_filters( 'angi_globally_enable_img_smart_load', !angi_fn_is_ajax() && esc_attr( angi_fn_opt( 'tc_img_smart_load' ) ) ) ) {
        add_filter( 'the_content'    , 'angi_fn_parse_imgs', PHP_INT_MAX );
        add_filter( 'angi_thumb_html' , 'angi_fn_parse_imgs'  );
        if ( apply_filters( 'angi_enable_img_smart_load_in_wc_short_description', false  ) ) {
...
function angi_fn_get_content_breadth() {
  ...
  return apply_filters( 'angi_content_breadth' , $content_breadth );
}
...
* @since Angilla 1.0
*/
function angi_fn_get_layout( $post_id , $sidebar_or_class = 'class' ) {
      global $post;
      ...
      /* Force 404 layout */
      if ( is_404() ) {
            $angi_screen_layout = array(
                'sidebar' => false,
                'class'   => 'col-12 col-md-8 offset-md-2'
            );
            return apply_filters( 'angi_screen_layout' , $angi_screen_layout[$sidebar_or_class], $post_id , $sidebar_or_class );
      }


      /* DEFAULT LAYOUTS */
      //what is the default layout we want to apply? By default we apply the global default layout
      $angi_sidebar_default_layout    = esc_attr( angi_fn_opt('tc_sidebar_global_layout') );
      $angi_sidebar_force_layout      = esc_attr( angi_fn_opt('tc_sidebar_force_layout') );

      //checks if the 'force default layout' option is checked and return the default layout before any specific layout
      if( $angi_sidebar_force_layout ) {
            $class_tab  = $global_layout[$angi_sidebar_default_layout];
            $class_tab  = $class_tab['content'];
            $angi_screen_layout = array(
                'sidebar' => $angi_sidebar_default_layout,
                'class'   => $class_tab
            );
            return apply_filters( 'angi_screen_layout' , $angi_screen_layout[$sidebar_or_class], $post_id , $sidebar_or_class );
      }
      ...
      if ( apply_filters( 'angi_is_post_layout', is_single( $post_id ), $post_id ) || angi_fn_is_attachment_image() ) {
            $_angi_sidebar_default_layout  = esc_attr( angi_fn_opt('tc_sidebar_post_layout') );
            $is_singular_layout           = true;
      } elseif ( apply_filters( 'angi_is_page_layout', is_page( $post_id ), $post_id ) ) {
            $_angi_sidebar_default_layout  = esc_attr( angi_fn_opt('tc_sidebar_page_layout') );
            $is_singular_layout           = true;
      }

      $angi_sidebar_default_layout     = empty($_angi_sidebar_default_layout) ? $angi_sidebar_default_layout : $_angi_sidebar_default_layout;
      ...
      $angi_specific_post_layout    = false;
      ...
      if ( isset($post) && is_singular() && 'attachment' == $post->post_type ) {
            $angi_specific_post_layout  = esc_attr( get_post_meta( $post_id, $key = 'layout_key' , $single = true ) );
            if ( ! $angi_specific_post_layout ) {
                $angi_specific_post_layout  = esc_attr( get_post_meta( $post->post_parent , $key = 'layout_key' , $single = true ) );
            }
      }
      ...
      if( ($wp_the_query->is_home() && 'posts' == get_option( 'show_on_front' ) ) || $wp_the_query->is_front_page()) {
            $angi_specific_post_layout = angi_fn_opt('tc_front_layout');
      }

      if ( $angi_specific_post_layout ) {

            $class_tab  = $global_layout[$angi_specific_post_layout];
            $class_tab  = $class_tab['content'];
            $angi_screen_layout = array(
                'sidebar' => $angi_specific_post_layout,
                'class'   => $class_tab
            );
...
* @package Angilla
*/
function angi_fn_get_page_wrapper_class() {
    if ( 'boxed' == esc_attr( angi_fn_opt( 'tc_site_layout') ) ) {
        $tc_page_wrap_class = array( 'container', 'angi-boxed' );
    } else {
        $tc_page_wrap_class = array();
    }

    return apply_filters( 'angi_page_wrapper_class' , $tc_page_wrap_class );
}
...
function angi_fn_fancybox_content_filter( $content) {
    ...
    return apply_filters( 'angi_fancybox_content_filter', $content );
}
...
function angi_fn_stringify_array( $array, $sep = ' ' ) {
    if ( is_array( $array ) )
...
function angi_fn_fire_cb( $cb, $params = array(), $return = false ) {
    $to_return = false;
...
function angi_fn_return_cb_result( $cb, $params = array() ) {
    return angi_fn_fire_cb( $cb, $params, $return = true );
}
...
//a callback can be function or a method of a class
//the class can be an instance!
function angi_fn_fire_cb_array( $cb, $params = array(), $return = false ) {
    $to_return = false;
    //method of a class => look for an array( 'class_name', 'method_name')
    if ( is_array($cb) && 2 == count($cb) ) {
      if ( is_object($cb[0]) ) {
...
function angi_fn_return_cb_result_array( $cb, $params = array() ) {
    return angi_fn_fire_cb_array( $cb, $params, $return = true );
}
...
*
*/
function angi_fn_is_slider_active( $queried_id = null ) {
  $queried_id = $queried_id ? $queried_id : angi_fn_get_real_id();
  //is the slider set to on for the queried id?
  if ( angi_fn_is_real_home() && angi_fn_opt( 'tc_front_slider' ) )
    return apply_filters( 'angi_slider_active_status', true , $queried_id );
  ...
  return apply_filters( 'angi_slider_active_status', false , $queried_id );
}
...
*
*/
function angi_fn_get_current_slider( $queried_id = null ) {
  $queried_id = $queried_id ? $queried_id : angi_fn_get_real_id();
  //gets the current slider id
  $_home_slider     = angi_fn_opt( 'tc_front_slider' );
  $slider_name_id   = ( angi_fn_is_real_home() && $_home_slider ) ? $_home_slider : esc_attr( get_post_meta( $queried_id, $key = 'post_slider_key' , $single = true ) );
  return apply_filters( 'angi_slider_name_id', $slider_name_id , $queried_id );
}


function angi_fn_post_has_title() {
    return ! in_array(
      get_post_format(),
      apply_filters( 'angi_post_formats_with_no_heading', array( 'aside' , 'status' , 'link' , 'quote' ) )
    );
}

/* TODO: caching system */
function angi_fn_get_logo_atts( $logo_type = '', $backward_compatibility = true ) {
    $logo_type_sep      = $logo_type ? '_sticky_' : '_';

    $_cache_key         = "angi{$logo_type_sep}logo_atts";
    ...
    $accepted_formats   = apply_filters( 'angi_logo_img_formats' , array('jpg', 'jpeg', 'png' ,'gif', 'svg', 'svgz' ) );
    ...
    $_logo_option       = $_logo_option ? $_logo_option : esc_attr( angi_fn_opt( "tc{$logo_type_sep}logo_upload") );
    ...
    if ( is_numeric($_logo_option) ) {
      ...
      $_saved_path      = esc_url ( angi_fn_opt( "tc{$logo_type_sep}logo_upload") );
 ...
 * @return bool
 */
function angi_fn_is_there_any_visible_menu_location_assigned() {

    $menu_locations = array(
        //location => condition
        'main'        => true,
        'topbar'      => 1 == angi_fn_opt( 'tc_header_desktop_topbar' ),
        'secondary'   => angi_fn_is_secondary_menu_enabled()
    );
...
function angi_fn_li_wrap( $el, $attrs = '' ) {
...
function angi_fn_set_post_list_context_class( $_class ) {
    if ( angi_fn_is_list_of_posts() )
      array_push( $_class , 'angi-post-list-context');
    return $_class;
}
...
function angi_fn_get_query_context() {
    if ( is_page() )
        return 'page';
...
function angi_fn_is_single_post() {
    global $post;
    return apply_filters( 'angi_is_single_post', isset($post)
        && is_singular()
        && 'page' != $post -> post_type
        && ! angi_fn_is_attachment_image()
        && ! angi_fn_is_home_empty()
        && ! angi_fn_is_real_home()
        );
}

function angi_fn_is_single_attachment_image() {
    global $post;
    return apply_filters( 'angi_is_single_attachment_image',
        ! ( ! isset($post) || empty($post) || ! angi_fn_is_attachment_image() || !is_singular() ) );
}

function angi_fn_is_single_attachment() {
    global $post;
    return apply_filters( 'angi_is_single_attachment',
        ! ( ! isset($post) || empty($post) || 'attachment' != $post -> post_type || !is_singular() ) );
}

function angi_fn_is_single_page() {
    return apply_filters( 'angi_is_single_page',
        'page' == angi_fn_get_post_type()
        && is_singular()
        && ! angi_fn_is_home_empty()
    );
}
...
*
*/
function angi_fn_get_real_id() {
    global $wp_query;
    $queried_id  = angi_fn_get_id();
    return apply_filters( 'angi_get_real_id', ( ! angi_fn_is_real_home() && ! empty($queried_id) ) ?  $queried_id : get_the_ID() );
}
...
* @since 3.1.0
*/
function angi_fn_get_the_post_list_article_selectors( $post_class = '', $id_suffix = '' ) {
    //gets global vars
    global $post;
    ...
    if ( isset($post) )
      $selectors = apply_filters( "angi_post_list_selectors", sprintf('%1$s %2$s',
        angi_fn_get_the_post_id( 'post', $post->ID, $id_suffix ),
        angi_fn_get_the_post_class( $post_class )
      ) );

    return apply_filters( 'angi_article_selectors', $selectors );
}//end of function
...
* @since 3.1.0
*/
function angi_fn_get_the_singular_article_selectors( $post_class = '' ) {
    //gets global vars
    global $post;
    ...
    if ( isset($post) ) {
      $post_type  = angi_fn_get_post_type();
      $selectors  = apply_filters( "angi_article_singular_{$post_type}_selectors", sprintf('%1$s %2$s',
        angi_fn_get_the_post_id( 'page' == $post_type ? $post_type : 'post', $post->ID ),
        angi_fn_get_the_post_class( $post_class )
      ) );
    }
...
* @since 3.0.10
*/
function angi_fn_get_the_post_class( $class = '', $post_id = null ) {
...
* @since 3.0.10
*/
function angi_fn_get_the_post_id( $type = 'post', $post_id = null, $id_suffix = '' ) {
    //Separates classes with a single space, collates classes for post DIV
...
* @since 4.0
*/
function angi_fn_is_loop_start() {
    global $wp_query;
...
* @since Angilla 1.0
*/
function angi_fn_get_thumbnail_model( $args = array() ) {
    ...
    //angi_fn_has_thumb() checks if there is a thumbnail or an attachment img ( typically img embedded in single post ) that we can use
    //=> the check on the attachement is done if true == angi_fn_opt( 'tc_post_list_use_attachment_as_thumb' )
    if ( ! angi_fn_has_thumb( $post_id, $custom_thumb_id ) ) {
      if ( ! $placeholder )
        return array();
      else
        return array( 'tc_thumb' => angi_fn_get_placeholder_thumb(), 'is_placeholder' => true );
    }

    $tc_thumb_size              = is_null($requested_size) ? apply_filters( 'angi_thumb_size_name' , 'tc-thumb' ) : $requested_size;
    $post_id                    = is_null($post_id) ? get_the_ID() : $post_id;

    $filtered_thumb_size_name   = ! is_null( $filtered_thumb_size_name ) ? $filtered_thumb_size_name : 'tc_thumb_size';
    $_filtered_thumb_size       = apply_filters( $filtered_thumb_size_name, $filtered_thumb_size_name ? ANGI___::$instance -> $filtered_thumb_size_name : null );
    ...
    if ( version_compare( $GLOBALS['wp_version'], '4.4', '>=' ) )
      $enable_wp_responsive_imgs = is_null( $enable_wp_responsive_imgs ) ? 1 == angi_fn_opt('tc_resp_thumbs_img') : $enable_wp_responsive_imgs;

    //try to extract $_thumb_id and $_thumb_type
    extract( angi_fn_maybe_set_and_get_thumb_info( $post_id, $custom_thumb_id ) );
    ...
    $_img_attr['class']     = sprintf(
      'attachment-%1$s tc-thumb-type-%2$s angi-img',
      $tc_thumb_size ,
      $_thumb_type
    );
    //Add the style value
    $_style                 = apply_filters( 'angi_post_thumb_inline_style' , '', $image, $_filtered_thumb_size );
    if ( $_style )
      $_img_attr['style']   = $_style;
    $_img_attr              = apply_filters( 'angi_post_thumbnail_img_attributes' , $_img_attr );
    ...
    if ( false === $enable_wp_responsive_imgs ) {
      ...
      $_img_attr['srcset']  = " ";
      add_filter( 'wp_get_attachment_image_attributes', 'angi_fn_remove_srcset_attr' );
    }
    //get the thumb html
    ...
    $tc_thumb = apply_filters( 'angi_thumb_html', $tc_thumb, $requested_size, $post_id, $custom_thumb_id, $_img_attr, $tc_thumb_size );

    return apply_filters( 'angi_get_thumbnail_model',
...
*/
function angi_fn_maybe_set_and_get_thumb_info( $_post_id = null, $_thumb_id = null ) {
    ...
    return angi_fn_set_thumb_info( $_post_id , $_thumb_id, true );
}
...
* @return bool
*/
function angi_fn_has_thumb( $_post_id = null , $_thumb_id = null ) {
    $_post_id  = is_null($_post_id) ? get_the_ID() : $_post_id;

    //try to extract (OVERWRITE) $_thumb_id and $_thumb_type
    extract( angi_fn_maybe_set_and_get_thumb_info( $_post_id, $_thumb_id ) );
...
*/
function angi_fn_set_thumb_info( $post_id = null , $_thumb_id = null, $_return = false ) {
    $post_id      = is_null($post_id) ? get_the_ID() : $post_id;
    $_thumb_type  = 'none';
    ...
    //3) default thumb
      ...
      if ( has_post_thumbnail( $post_id ) ) {
        ...
        $_thumb_id    = angi_fn_get_id_from_attachment( $post_id );
    ...
    if ( $_return )
      return apply_filters( 'angi_set_thumb_info' , compact( "_thumb_id" , "_thumb_type" ), $post_id );
}//end of fn


function angi_fn_get_id_from_attachment( $post_id ) {
    ...
    if ( ! is_admin() )
      $_bool = ! angi_fn_is_single_post() && $_bool;

    if ( ! apply_filters( 'angi_use_attachment_as_thumb' , $_bool ) )
      return;

    //Case if we display a post or a page
    if ( 'attachment' != get_post_type( $post_id ) ) {
      //look for the last attached image in a post or page
      $tc_args = apply_filters('angi_attachment_as_thumb_query_args' , array(
          'numberposts'             =>  1,
...
function angi_fn_render_thumb_view( $_thumb_model , $layout = 'span3', $_echo = true ) {
    ...
    $thumb_img        = apply_filters( 'angi_post_thumb_img', $thumb_img, angi_fn_get_id() );
    if ( ! $thumb_img )
      return;

    //handles the case when the image dimensions are too small
    $thumb_size       = apply_filters( 'angi_thumb_size' , ANGI___::$instance -> tc_thumb_size, angi_fn_get_id()  );
    ...
    $thumb_wrapper    = sprintf('<div class="%5$s %1$s"><div class="round-div"></div><a class="round-div %1$s" href="%2$s" title="%3$s"></a>%4$s</div>',
                                  implode( " ", apply_filters( 'angi_thumbnail_link_class', array( $no_effect_class ) ) ),
                                  get_permalink( get_the_ID() ),
                                  esc_attr( strip_tags( get_the_title( get_the_ID() ) ) ),
                                  $thumb_img,
                                  implode( " ", apply_filters( 'angi_thumb_wrapper_class', array('thumb-wrapper') ) )
    );

    $thumb_wrapper    = apply_filters_ref_array( 'angi_post_thumb_wrapper', array( $thumb_wrapper, $thumb_img, angi_fn_get_id() ) );

    //cache the thumbnail view
    $html             = sprintf('<section class="tc-thumbnail %1$s">%2$s</section>',
      apply_filters( 'angi_post_thumb_class', $layout ),
      $thumb_wrapper
    );
    $html = apply_filters_ref_array( 'angi_render_thumb_view', array( $html, $_thumb_model, $layout ) );
    if ( ! $_echo )
      return $html;
    echo $html;
}//end of function
...
/* ------------------------------------ */
if ( ! function_exists( 'angi_fn_get_placeholder_thumb' ) ) {
  function angi_fn_get_placeholder_thumb( $_requested_size = 'thumb-standard' ) {
    $_unique_id = uniqid();
    $filter = false;
    ...
    //default $img_src
    $_img_src = angi_fn_get_theme_file_url( ANGI_ASSETS_PREFIX . "front/img/{$_requested_size}.png" );
    if ( apply_filters( 'angi-use-svg-thumb-placeholder', true ) ) {
        $_size = $_requested_size . '-empty';
        $_img_src = angi_fn_get_theme_file_url( ANGI_ASSETS_PREFIX . "front/img/{$_size}.png" );
        $_svg_height = in_array($_size, array( 'thumb-medium', 'thumb-standard' ) ) ? 100 : 60;
        ob_start();
        ?>
        <svg class="angi-svg-placeholder <?php echo $_size; ?>" id="<?php echo $_unique_id; ?>" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg"><path d="M928 832q0-14-9-23t-23-9q-66 0-113 47t-47 113q0 14 9 23t23 9 23-9 9-23q0-40 28-68t68-28q14 0 23-9t9-23zm224 130q0 106-75 181t-181 75-181-75-75-181 75-181 181-75 181 75 75 181zm-1024 574h1536v-128h-1536v128zm1152-574q0-159-112.5-271.5t-271.5-112.5-271.5 112.5-112.5 271.5 112.5 271.5 271.5 112.5 271.5-112.5 112.5-271.5zm-1024-642h384v-128h-384v128zm-128 192h1536v-256h-828l-64 128h-644v128zm1664-256v1280q0 53-37.5 90.5t-90.5 37.5h-1536q-53 0-90.5-37.5t-37.5-90.5v-1280q0-53 37.5-90.5t90.5-37.5h1536q53 0 90.5 37.5t37.5 90.5z"/></svg>
    ...
    $_img_src = apply_filters( 'angi_placeholder_thumb_src', $_img_src, $_requested_size );
    $filter = apply_filters( 'angi_placeholder_thumb_filter', false );
    ...
    $attr = array(
      'class'             => 'angi-img-placeholder',
      'src'               => $_img_src,
      'alt'               => trim( strip_tags( get_the_title() ) ),
      'data-angi-post-id'  => $_unique_id,
    ...
    $attr = apply_filters( 'angi_placeholder_image_attributes', $attr );
    $attr = array_filter( array_map( 'esc_attr', $attr ) );

    return sprintf( '%1$s%2$s<img class="%3$s" src="%4$s" alt="%5$s" data-angi-post-id="%6$s" width="%7$s" height="%8$s"/>',
      isset($_svg_placeholder) ? $_svg_placeholder : '',
      false !== $filter ? $filter : '',
      isset( $attr[ 'class' ] ) ? $attr[ 'class' ] : '',
      isset( $attr[ 'src' ] ) ? $attr[ 'src' ] : '',
      isset( $attr[ 'alt' ] ) ? $attr[ 'alt' ] : '',
      isset( $attr[ 'data-angi-post-id' ] ) ? $attr[ 'data-angi-post-id' ] : '',
...
function angi_fn_remove_srcset_attr( $attr ) {
    if ( isset( $attr[ 'srcset' ] ) ) {
      ...
      remove_filter( current_filter(), 'angi_fn_remove_srcset_attr' );
    }
    return $attr;
}
...
/*  Darken hex color
/* ------------------------------------ */
if ( ! function_exists( 'angi_fn_darken_hex' ) ) {
   function angi_fn_darken_hex( $hex, $percent, $make_prop_value = true ) {

      $hsl      = angi_fn_hex2hsl( $hex );

      $dark_hsl   = angi_fn_darken_hsl( $hsl, $percent );

      return angi_fn_hsl2hex( $dark_hsl, $make_prop_value );
   }
}

/*  Lighten hex color
/* ------------------------------------ */
if ( ! function_exists( 'angi_fn_lighten_hex' ) ) {

   function angi_fn_lighten_hex($hex, $percent, $make_prop_value = true) {

      $hsl       = angi_fn_hex2hsl( $hex );

      $light_hsl   = angi_fn_lighten_hsl( $hsl, $percent );

      return angi_fn_hsl2hex( $light_hsl, $make_prop_value );
   }
}

/*  Darken rgb color
/* ------------------------------------ */
if ( ! function_exists( 'angi_fn_darken_rgb' ) ) {
   function angi_fn_darken_rgb( $rgb, $percent, $array = false, $make_prop_value = false ) {

      $hsl      = angi_fn_rgb2hsl( $rgb, true );

      $dark_hsl   = angi_fn_darken_hsl( $hsl, $percent );

      return angi_fn_hsl2rgb( $dark_hsl, $array, $make_prop_value );
   }
}

/*  Lighten rgb color
/* ------------------------------------ */
if ( ! function_exists( 'angi_fn_lighten_rgb' ) ) {

   function angi_fn_lighten_rgb($rgb, $percent, $array = false, $make_prop_value = false ) {

      $hsl      = angi_fn_rgb2hsl( $rgb, true );

      $light_hsl = angi_fn_lighten_hsl( $light_hsl, $percent );

      return angi_fn_hsl2rgb( $light_hsl, $array, $make_prop_value );
...
/* Darken/Lighten hsl
/* ------------------------------------ */
if ( ! function_exists( 'angi_fn_darken_hsl' ) ) {
   function angi_fn_darken_hsl( $hsl, $percentage, $array = true ) {
...
/* Lighten hsl
/* ------------------------------------ */
if ( ! function_exists( 'angi_fn_lighten_hsl' ) ) {
   function angi_fn_lighten_hsl( $hsl, $percentage, $array = true  ) {
...
/* ------------------------------------ */
if ( ! function_exists( 'angi_fn_hex2rgb' ) ) {
   function angi_fn_hex2rgb( $hex, $array = false, $make_prop_value = false ) {
...
/* ------------------------------------ */
if ( ! function_exists( 'angi_fn_hex2rgba' ) ) {
   function angi_fn_hex2rgba( $hex, $alpha = 0.7, $array = false, $make_prop_value = false ) {

      $rgb = $rgba = angi_fn_hex2rgb( $hex, $_array = true );
...
/*  Convert rgb to rgba
/* ------------------------------------ */
if ( ! function_exists( 'angi_fn_rgb2rgba' ) ) {
   function angi_fn_rgb2rgba( $rgb, $alpha = 0.7, $array = false, $make_prop_value = false ) {
...
/* ------------------------------------ */
if ( ! function_exists( 'angi_fn_rgb2hex' ) ) {
   function angi_fn_rgb2hex( $rgb, $make_prop_value = false ) {
...
/*  Convert rgb to hsl
/* ------------------------------------ */
if ( ! function_exists( 'angi_fn_rgb2hsl' ) ) {
   function angi_fn_rgb2hsl( $rgb, $array = false ) {
...
/*  Convert hsl to rgb
/* ------------------------------------ */
if ( ! function_exists( 'angi_fn_hsl2rgb' ) ) {

   function angi_fn_hsl2rgb( $hsl, $array=false, $make_prop_value = false ) {
      ...
      if ( 0 !=$S ) {
         ...
         $rgb[0] = angi_fn_hue2rgbtone( $var_1, $var_2, $H + ( 1/3 ) );
         $rgb[1] = angi_fn_hue2rgbtone( $var_1, $var_2, $H );
         $rgb[2] = angi_fn_hue2rgbtone( $var_1, $var_2, $H - ( 1/3 ) );
      }
...
/* Convert hsl to hex
/* ------------------------------------ */
if ( ! function_exists( 'angi_fn_hsl2hex' ) ) {
   function angi_fn_hsl2hex( $hsl = array(), $make_prop_value = false ) {
      $rgb = angi_fn_hsl2rgb( $hsl, $array = true );

      return angi_fn_rgb2hex( $rgb, $make_prop_value );
   }
}

/* Convert hex to hsl
/* ------------------------------------ */
if ( ! function_exists( 'angi_fn_hex2hsl' ) ) {
   function angi_fn_hex2hsl( $hex ) {
      $rgb = angi_fn_hex2rgb( $hex, true );

      return angi_fn_rgb2hsl( $rgb, true );
   }
}

/* Convert hue to rgb
/* ------------------------------------ */
if ( ! function_exists( 'angi_fn_hue2rgbtone' ) ) {
   function angi_fn_hue2rgbtone( $v1, $v2, $vH ) {
      $_to_return = $v1;
...
/* ------------------------------------ */
function angi_fn_rgb_invert( $rgb )  {
...
/* Returns the complementary hsl color
/* ------------------------------------ */
function angi_fn_hex_invert( $hex, $make_prop_value = true )  {   
   $rgb           = angi_fn_hex2rgb( $hex, $array = true );
   $rgb_inverted  = angi_fn_rgb_invert( $rgb );

   return angi_fn_rgb2hex( $rgb_inverted, $make_prop_value );
}
