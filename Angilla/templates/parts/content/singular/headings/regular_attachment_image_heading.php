    ...
    <div class="header-bottom">
      <div class="post-info">
        ...
        <?php
            ...
            // angi_fn_get_property( 'publication_date', 'post_metas', array( false, null, true )
            // means:
            ...
            if ( $date = angi_fn_get_property( 'publication_date', 'post_metas', array( false, null, true )  ) )
              if ( $author ) : ?><span class="v-separator">|</span><?php endif; echo $date;

            if ( $up_date = angi_fn_get_property( 'update_date', 'post_metas', array( false, null, true ) ) )  {
            ...
            if ( $attachment_image_info = angi_fn_get_property( 'attachment_image_info', 'post_metas' ) ) :
