<?php
class ANGI_attachment_image_content_model_class extends ANGI_Model {
    //bools
    ...
    */
    function angi_fn_setup_late_properties() {
        ...
        //see: this->angi_fn_reset_late_properties
        //
        ...
        $this->angi_fn_setup_attachment_content();
    }


    function angi_fn_setup_attachment_content() {
        ...
        $lightbox_on = 0 != esc_attr( angi_fn_opt( 'tc_fancybox' ) );
        ...
        $attachment_size            = apply_filters( 'angi_angilla_attachment_size' , $this->defaults['attachment_size'] );

        //update the model
        $this -> angi_fn_update( compact(
            'attachment_gallery',
            'attachment_size',
            'attachment_class',
            'attachment_caption',
