(function (api, $, _) {
          ...
          api.ANGI_ctrlDependencies.prototype.dominiDeps = _.extend(
                api.ANGI_ctrlDependencies.prototype.dominiDeps,
                [
                    {
                            ...
                            visibility : function( to, servusShortId ) {
                                ...
                                if ( 'tc_sticky_show_tagline' == servusShortId ) {
                                  _to_return = _to_return && _is_checked( api( api.ANGI_Helpers.build_setId( 'tc_sticky_header' ) ).get() ) && _is_checked( api( api.ANGI_Helpers.build_setId( 'tc_show_tagline' ) ).get() );
                                }
                                return _to_return;
                            },
                            actions : function( to, servusShortId ) {
                                ...
                                var _servus            = api( api.ANGI_Helpers.build_setId( servusShortId ) );
                    ...
                    },
                    {
                            ...
                            visibility : function( to, servusShortId ) {
                                  ...
                                  if ( 'tc_show_post_navigation_home' == servusShortId ) {
                                    return ( 'posts' == to  ) && _is_checked( api( api.ANGI_Helpers.build_setId( 'tc_show_post_navigation' ) ).get() );
                                  }
                                  if ( 'posts' == to ) {
                                    return true;
                                  }
                                  if ( 'page' == to && 'tc_blog_restrict_by_cat' == servusShortId ) { //show cat picker also if a page for posts is set
                                    return _is_checked( api( api.ANGI_Helpers.build_setId( 'page_for_posts' ) ).get() );
                                  }
                                  return false;
                            },
                    },
                    ...
                    },
                    {
                            ...
                            visibility : function( to, servusShortId ) {
                                  ...
                                  if ( 'tc_header_topbar_layout' == servusShortId ) {
                                        return ( 'wide' == to  ) && _is_checked( api( api.ANGI_Helpers.build_setId( 'tc_header_show_topbar' ) ).get() );
                                  }
                                  else if ( 'tc_mc_effect' == servusShortId ) {
                                        return 'aside' == api( api.ANGI_Helpers.build_setId( 'tc_menu_style' ) ).get() && 'wide' == to;
                                  }
                                  return  'wide' == to;
                            },
                    },
                    {
                            ...
                            visibility: function (to) {
                                  //cross
                                  return _is_checked(to) &&  'wide' == api( api.ANGI_Helpers.build_setId( 'tc_site_layout' ) ).get();
                            }
                    },
                    ...
                    //as soon as you expand a section where they're placed, whether or not their real dominus are actually present in the same section
                    {
                            ...
                            visibility : function( to ) {
                                  return _is_checked( api( api.ANGI_Helpers.build_setId( 'tc_header_show_topbar' ) ).get() ) &&  'wide' == api( api.ANGI_Helpers.build_setId( 'tc_site_layout' ) ).get();
                            }
                    },
                    {
                            ...
                            visibility : function( to ) {
                                  return 'wide' == api( api.ANGI_Helpers.build_setId( 'tc_site_layout' ) ).get();
                            }
                    },
                    {
                    ...
                    },
                    {
                            ...
                            visibility : function( to ) {
                                  return 'aside' == api( api.ANGI_Helpers.build_setId( 'tc_menu_style' ) ).get() && 'wide' == api( api.ANGI_Helpers.build_setId( 'tc_site_layout' ) ).get();
                            }
                    },
                    {
                    ...
                    },
                    {
                            ...
                            actions : function( to, servusShortId ) {
                                 ...
                                 var $_front_slider_container = api.control( api.ANGI_Helpers.build_setId('tc_front_slider') ).container,
                                     $_label = $( 'label' , $_front_slider_container ),
                                     $_empty_sliders_notice = $( 'div.angi-notice', $_front_slider_container);

                                  if ( 0 < $_empty_sliders_notice.length )
                                      $_empty_sliders_notice.show();

                                  if ( 'tc_posts_slider' == to ) {
                                    if ( 0 !== $_label.length && ! $('.angi-notice' , $_label ).length ) {
                                      var $_notice = $('<span>', { class: 'angi-notice', html : themeServerControlParams.i18n.postSliderNote || '' } );
                                      $_label.append( $_notice );
                                    }
                                    else {
                                      $('.angi-notice' , $_label ).show();
                                    }

                                  }
                                  else {
                                    if ( 0 !== $( '.angi-notice' , $_label ).length )
                                      $( '.angi-notice' , $_label ).hide();
                                    if ( 0 !== $_empty_sliders_notice.length )
                                      $_empty_sliders_notice.show();
                                  }
                            }
                    },
                    {
                            ...
                            visibility : function( to ) {
                                  ...
                                  return _defaultHeight != to && 'demo' != api( api.ANGI_Helpers.build_setId( 'tc_front_slider' ) ).get();
                            },
                    },
                    {
                            ...
                            visibility : function( to ) {
                                  return ( to.indexOf('cta') > -1 ) && ( 'tc_posts_slider' == api( api.ANGI_Helpers.build_setId( 'tc_front_slider' ) ).get() );
                            },
                    },
                    {
                            ...
                            visibility : function( to, servusShortId ) {
                                  if ( 'tc_grid_thumb_height' == servusShortId ) {
                                      ...
                                      return _is_checked(to)
                                          ...
                                          && 'grid' == api( api.ANGI_Helpers.build_setId( 'tc_post_list_grid' ) ).get();
                                  }
                                  if ( 'tc_gallery_carousel_post_list' == servusShortId ) {
                                      return _is_checked(to) && _.contains( ['masonry', 'alternate'], api( api.ANGI_Helpers.build_setId( 'tc_post_list_grid' ) )() );
                                  }
                    ...
                    },
                    {
                            ...
                            visibility : function( to ) {
                                  return _is_checked(to) && 'grid' == api( api.ANGI_Helpers.build_setId( 'tc_post_list_grid' ) )();
                            },
                    },
                    {
                            ...
                            visibility : function( to, servusShortId ) {
                                  ...
                                  if (  -1 != servusShortId.indexOf( 'tc_gc_' ) ) {
                                      if ( 'tc_gc_enabled' == servusShortId ) {
                                          ...
                                          return 'grid' == to && '1' == api( api.ANGI_Helpers.build_setId( 'tc_gc_enabled' ) )();
                                      }
                                  }
                                  ...
                                  if ( 'tc_gallery_carousel_post_list' == servusShortId ) {
                                     return  _.contains( ['masonry', 'alternate'], to ) && _is_checked( api( api.ANGI_Helpers.build_setId( 'tc_post_list_show_thumb' ) )() );
                                  }
                                  ...
                                  if ( _.contains( themeServerControlParams.gridDesignControls, servusShortId ) ) {
                                      ...
                                      if ( 'tc_grid_thumb_height' == servusShortId ) {
                                        //cross
                                          return _bool && _is_checked( api( api.ANGI_Helpers.build_setId( 'tc_post_list_show_thumb' ) ).get() );
                                      }
                                      return _bool;
                                  }
                                  if ( 'tc_post_list_thumb_position' == servusShortId || 'tc_post_list_thumb_alternate' == servusShortId || 'tc_post_list_thumb_shape' == servusShortId ) {
                                    return 'alternate' == to && _is_checked( api( api.ANGI_Helpers.build_setId( 'tc_post_list_show_thumb' ) )() ) ;
                                  }
                    ...
                    //are actually present in the same section
                    {
                            ...
                            visibility : function( to ) {
                                  return _.contains( ['masonry', 'alternate'], api( api.ANGI_Helpers.build_setId( 'tc_post_list_grid' ) )() ) && _is_checked( api( api.ANGI_Helpers.build_setId( 'tc_post_list_show_thumb' ) )() );
                            }
                    },
                    {
                            ...
                            visibility: function (to, servusShortId ) {
                                  ...
                                  switch( servusShortId ) {
                                      ...
                                      case 'tc_header_custom_fg_color' :
                                          bool = ! _is_checked(to) && 'custom' === api( api.ANGI_Helpers.build_setId( 'tc_header_skin' ) )();
                                      break;
                                      case 'tc_header_skin' :
                                          bool = ! _is_checked(to);
                                      break;
                    ...
                    */
                    ...
                    },
                    {
                            ...
                            visibility : function( to, servusShortId ) {
                                  if ( 'tc_woocommerce_header_cart_sticky' == servusShortId ) {
                                    return _is_checked(to) && _is_checked( api( api.ANGI_Helpers.build_setId( 'tc_woocommerce_header_cart' ) ).get() );
                                  }
                                  //cross dependency
                                  if ( 'tc_sticky_show_tagline' == servusShortId ) {
                                    return !_.isEmpty( api( api.ANGI_Helpers.build_setId( 'blogdescription' ) ).get() ) && _is_checked( to ) && _is_checked( api( api.ANGI_Helpers.build_setId( 'tc_show_tagline' ) ).get() );
                                  }
                    ...
                    },
                    {
                            ...
                            visibility: function (to) {
                                  return _is_checked(to) && _is_checked( api( api.ANGI_Helpers.build_setId( 'tc_sticky_header' ) ).get() );
                            }
                    },
                    {
                    ...
                    },
                    {
                            ...
                            visibility : function( to, servusShortId ) {
                                  if ( 'tc_comment_bubble_color' == servusShortId ) {
                                    return _is_checked(to) && 'custom' == api( api.ANGI_Helpers.build_setId( 'tc_comment_bubble_color_type' ) ).get();
                                  }
                                  return _is_checked(to);
                            },
                    },
                    ...
                    },
                    {
                            ...
                            actions : function( to, servusShortId ) {
                                  var $_skin_select = api.control( api.ANGI_Helpers.build_setId(servusShortId) ).container;
                    ...
                    },
                    {
                            ...
                            visibility : function( to, servusShortId ) {
                                  var _menu_style_val = api( api.ANGI_Helpers.build_setId( 'tc_menu_style' )).get();
                    ...
                    },
                    {
                            ...
                            visibility : function( to, servusShortId ) {
                                  ...
                                  //CASE 2 : side menu choosen
                                    ...
                                    if ( 'tc_mc_effect' == servusShortId ) {
                                      return 'boxed' != api( api.ANGI_Helpers.build_setId('tc_site_layout') ).get();
                                    }
                                    if ( _.contains([
                                        'tc_menu_type',
                                        'tc_menu_submenu_fade_effect',
                                      ...
                                      return _is_checked( api( api.ANGI_Helpers.build_setId('tc_display_second_menu') ).get() );
                                    }
                                    else if ( _.contains([
                                        'tc_menu_resp_dropdown_limit_to_viewport',
                            ...
                            actions : function( to, servusShortId ) {
                                  ...
                                  if ( 'tc_menu_style' == servusShortId ) {
                                    var $_container = api.control(api.ANGI_Helpers.build_setId( servusShortId )).container;
                                        $_notice    = $_container.children('.angi-notice');
                                    if ( 0 === $_notice.length ) {
                                      $_notice = $('<span>', { class: 'angi-notice', html : themeServerControlParams.i18n.sidenavNote || '' } );
                    ...
                    },
                    {
                            ...
                            visibility: function (to, servusShortId ) {
                                  ...
                                  var _to_return = !_.isEmpty( api( api.ANGI_Helpers.build_setId( 'blogdescription' ) ).get() );
                                  //cross dependency
                                  if ( 'tc_sticky_show_tagline' == servusShortId ) {
                                    _to_return  = _to_return && _is_checked( api( api.ANGI_Helpers.build_setId( 'tc_sticky_header' ) ).get() ) && _is_checked( to );
                                  }
                                  return _to_return;
                            },
                    },
                    {
                            ...
                            actions : function( to, servusShortId ) {
                                  var $_nav_section_container = api.section('nav').container,
                                      $_controls = $_nav_section_container.find('li.customize-control').not( api.control(api.ANGI_Helpers.build_setId(servusShortId)).container );
