...
(function (api, $, _ ) {
      var $_body    = $( 'body' ),
          setting_cbs = api.ANGI_preview.prototype.setting_cbs || {},
          input_cbs = api.ANGI_preview.prototype.input_cbs || {},
          _settingsCbsExtend = {},
          _inputCbsExtend = {};
    ...
    _settingsCbsExtend = {
        ...
        ******************************************/
          ...
          'tc_fonts' : function( to ) {
              ...
              _.delay( function() {
                  angiapp.$_header.trigger( 'refresh-sticky-header' );
              }, 100 );
          },
        ...
        ******************************************/
          ...
          'tc_menu_position' : function( to ) {
            if ( 'aside' != api( api.ANGI_preview.prototype._build_setId('tc_menu_style') ).get() ) {
        ...
        ******************************************/
          'tc_slider_default_height' : function( to ) {
            $('#angilla-slider').addClass('custom-slider-height');
      ...
      $.extend( api.ANGI_preview.prototype, {
