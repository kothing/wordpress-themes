...
var Collapse = function ($$$1) {
  var NAME = 'angiCollapse';
  var VERSION = '1.0.1';
  var DATA_KEY = 'angi.angiCollapse';
  ...
  var ClassName = {
    SHOW: 'show',
    COLLAPSE: 'angi-collapse',
    COLLAPSING: 'angi-collapsing',
    COLLAPSED: 'angi-collapsed'
  };
  var Dimension = {
    WIDTH: 'width',
    HEIGHT: 'height'
  ...
  var Selector = {
    ACTIVES: '.show, .angi-collapsing',
    DATA_TOGGLE: '[data-toggle="angi-collapse"]'
  ...
  function () {
    function Collapse(element, config) {
      ...
      this._triggerArray = $$$1.makeArray($$$1("[data-toggle=\"angi-collapse\"][href=\"#" + element.id + "\"]," + ("[data-toggle=\"angi-collapse\"][data-target=\"#" + element.id + "\"]")));
    ...
    _proto._getParent = function _getParent() {
      ...
      var selector = "[data-toggle=\"angi-collapse\"][data-parent=\"" + this._config.parent + "\"]";
...
var Tab = function ($$$1) {
  ...
  var Selector = {
    ...
    ACTIVE: '.active',
    ACTIVE_UL: '> li > .active',
    DATA_TOGGLE: '[data-toggle="angi-tab"], [data-toggle="angi-pill"], [data-toggle="angi-list"]',
...
exports.angiUtil = Util;
exports.angiCollapse = Collapse;
exports.angiTab = Tab;
  ...
  var pluginName = 'animateSvg',
      ...
      _drawSvgIcon = function(options) {
          ...
          if ( _.isUndefined(id) || _.isEmpty(id) || 'function' != typeof( Vivus ) ) {
            if ( window.angiapp )
              angiapp.consoleLog( 'An svg icon could not be animated with Vivus.');
            return;
          }
          if ( $('[id=' + id + ']').length > 1 ) {
            if ( window.angiapp )
              angiapp.consoleLog( 'Svg icons must have a unique css #id to be animated. Multiple id found for : ' + id );
          }
...
(function( $ ){
  ...
  $.fn.angiFitText = function( kompressor, options ) {
    ...
    return this.each(function(){
      ...
      resizer();
      $(window).on('resize.angiFittext orientationchange.angiFittext', resizer);

    });

  };

})( jQuery );// Angilla version of Galambosi's SmoothScroll
