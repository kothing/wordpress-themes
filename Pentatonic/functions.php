...
function active_webstacks_notice() {
    $notice = '<div id="setting-error-tgmpa" class="notice notice-info is-dismissible"> 
				<p>
					<b>通知：</b> Pentatonic 主题已激活，鉴于之前很多用户使用时都遇到了问题，请您先去 
...
function custom_dashboard_help() {
    echo '<li style="font-size:18px;color: red">'.__('先保存一次主题设置选项，否则会报错','i_theme').'</li>
        <p>首次安装检查如下设置：</p>
		...
		<p>主题使用注意事项：</p>
		<ul style="list-style:decimal;padding-left:15px">
			<li>请先查看：<a href="https://nice-boy.com/" target="_blank">主题使用说明</a></li>
            ...
            <li>阿里图标 Iconfont：<a href="https://nice-boy.com/" target="_blank">使用方法</a></li>
            <li>侧栏菜单设置方法：<a href="https://nice-boy.com/" target="_blank" style="color: red">必看</a></li>
        </ul>
        <p>推荐插件：</p>
		<ul style="list-style:decimal;padding-left:15px">
...
function example_add_dashboard_widgets() {
    wp_add_dashboard_widget('custom_help_widget', __('Pentatonic 主题使用说明','i_theme'), 'custom_dashboard_help');
}
