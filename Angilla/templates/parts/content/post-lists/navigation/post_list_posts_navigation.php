...
$_older_label      = __( 'Older posts' , 'angilla' );
$_newer_label      = __( 'Newer posts' , 'angilla' );
...
?>
<div class="row post-navigation <?php angi_fn_echo( 'element_class' ) ?>" <?php angi_fn_echo('element_attributes') ?>>
  <nav id="nav-below" class="col-12" role="navigation">
    <h2 class="sr-only"><?php _e('Posts navigation', 'angilla') ?></h2>
