<?php
class ANGI_post_list_item_content_inner_model_class extends ANGI_Model {
      ...
      /* Public api */
      public function angi_fn_get_element_class() {
      ...
      */
      ...
      public function angi_fn__setup_content() {
            ...
            switch ( $content_type ) {
                  ...
                  case 'quote'   :
                        ...
                        $_instance->angi_fn_setup();

                        $this->angi_fn__setup_content_to_render( $content = $_instance->angi_fn_get_raw_content(), $content_template = 'content/common/text/quote', $model_id = $_instance->angi_fn_get_property( 'id' ) );
                  ...
                  case 'link'   :
                        ...
                        $this->angi_fn__setup_content_to_render( $content = $_instance->angi_fn_get_raw_content(), $content_template = 'content/common/text/link', $model_id = $_instance->angi_fn_get_property( 'id' ) );

                  break;

                  case 'full'   :
                        $more = __( 'Continue reading <span class="meta-nav">&rarr;</span>' , 'angilla' );
                        $this->angi_fn__setup_content_to_render( $content = $this -> angi_fn_add_support_for_shortcode_special_chars( get_the_content( $more ) ) );

                  break;

                  default:
                        $this->angi_fn__setup_content_to_render( apply_filters( 'the_excerpt', get_the_excerpt( $post_id ) ) );

            }//end switch

            //always fallback on the excerpt?
            if ( is_null( $this->content ) )
                  $this->angi_fn__setup_content_to_render( apply_filters( 'the_excerpt', get_the_excerpt() ) );
      ...
      protected function angi_fn__setup_content_to_render( $content, $content_template = null , $model_id = null ) {

            if ( $content ) {

                  $this->angi_fn_set_property( 'content',  $content );


                  $this->angi_fn_set_property( 'content_template',  $content_template );


                  $this->angi_fn_set_property( 'content_args',  array( 'model_id' => $model_id, 'reset_to_defaults' => false ) );
