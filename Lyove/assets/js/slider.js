		...
		methods = {
			...
			controlNav: {
				...
				setupPaging: function() {
                    ...
                    setTimeout(function(){
                        slider.controlNavScaffold.css({'display': 'block'});
                    },50);
				},
				set: function() {
					var selector = 'a';
			...
			directionNav: {
				setup: function() {
					var directionNavScaffold = $( '<ul class="' + namespace + 'direction-nav"><li><a class="' + namespace + 'prev" href="#"><i class="genericon genericon-previous"></i>' + slider.vars.prevText + '</a></li><li><a class="' + namespace + 'next" href="#"><i class="genericon genericon-next"></i>' + slider.vars.nextText + '</a></li></ul>' );
                    ...
                    setTimeout(function(){
                        directionNavScaffold.css({'display': 'block'});
                    },50);
				},
				update: function() {
