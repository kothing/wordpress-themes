...
function fav_con($mid) { ?>
    <div class="site-category ">
        <h4 class="category-name text-gray">
            <i class="icon-io-tag" id="term-<?php echo $mid->term_id; ?>"></i>
            <?php echo $mid->name; ?>
        </h4>
        <?php 
            ...
            $count            = $site_n;
            if($site_n == 0) {
                $count = min(get_option('posts_per_page'),$category_count);
            }
